...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div id="headbox"  style="border: 1px solid #000000; text-align:center; height:32px; width:96%; font-weight:bolder; font-size:25px;">กรุณา เลือกประเภท การทำรายการ</div>                    
    <uc1:DsMain ID="dsMain" runat="server" />
    <br />
     <span id="F_dwTax" style="display:none"><uc2:DwTax ID="dwTax" runat="server" /></span>
    <br />
