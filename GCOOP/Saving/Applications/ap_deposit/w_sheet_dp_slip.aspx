<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_slip.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_slip" Title="Untitled Page"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CallPrintBook(slipNo) {
            Gcoop.OpenIFrame(900, 500, "w_dlg_dp_printbook.aspx", "");
        }
        ...
        function OnButtonClicked(s, row, oName) {
            if (oName == "b_account") {
                ...
                Gcoop.OpenIFrame(800, 460, "w_dlg_dp_deptstatement.aspx", "?accountNo=" + objDwMain.GetItem(1, "deptaccount_no"));
            } else if (oName == "cb_referslip") {
                var recpPayType = objDwMain.GetItem(row, "recppaytype_code");
                if (recpPayType == "DTR" || recpPayType == "WTR") {
                    Gcoop.OpenIFrame(650, 600, "w_dlg_dp_slip_search_tran.aspx", "?accountNo=" + objDwMain.GetItem(1, "deptaccount_no"));
                }
                ...
                if (coopid == "027001") {
                    dpdept_no = objDwMain.GetItem(1, "deptaccount_no");
                    Gcoop.OpenIFrame2("918", "533", "w_dlg_dp_signature.aspx", "?dpdept_no=" + dpdept_no);
                }
                else if (coopid == "028001") {
                    dpdept_no = objDwMain.GetItem(1, "deptaccount_no");
                    Gcoop.OpenIFrame2("600", "600", "w_dlg_dp_signature.aspx", "?dpdept_no=" + dpdept_no);
                }
                else {
                    dpdept_no = objDwMain.GetItem(1, "deptformat");
                    Gcoop.OpenIFrame2Extend("600", "500", "w_dlg_dp_signature.aspx", "?dpdept_no=" + dpdept_no);
                }
            } 
            return 0;
        }
        ...
        function OnDwChequeClick(s, r, c) {
            ...
            if (c == "bank_name" || c == "branch_name") {
                ...
                Gcoop.OpenIFrame(860, 600, "w_dlg_bank_and_branch.aspx", "?sheetRow=" + r + "&bankCodeQuery=" + bankCode);
            } else if (c == "late_flag") {
                var v = s.GetItem(r, c);
        ...
        function SheetLoadComplete() {
            ...
            if (printFlag == "true") {
                ...
                if (argPrintBook != "") {
                    //PRINTBOOK-DOYS
                    Gcoop.OpenIFrame(900, 550, "w_dlg_dp_printbook.aspx", "?deptAccountNo=" + argPrintBook);
                }
            }
