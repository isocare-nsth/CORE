...
{
    public partial class w_sheet_dpdepttypecond : PageWebSheet, WebSheet
    {
        ...
        protected String jsPostChgfixDate;
        ...
        public void InitJsPostBack()
        {
            ...
            jsPostChgfixDate = WebUtil.JsPostBack(this, "jsPostChgfixDate");
            tDwInterestNew = new DwThDate(DwInterestNew);
            tDwInterestNew.Add("use_date", "use_tdate");
            tDwFix = new DwThDate(DwFix);
            tDwFix.Add("due_date", "due_tdate");
        }
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sql = "select  min(persongrp_code) as persongrp_code from DPUCFACCTYPEGRP";
                Sdt dt = WebUtil.QuerySdt(sql);
                if (dt.Next())
                {
                    Hdpersong.Value = dt.GetString("persongrp_code");
                }
            }
            else
            {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            //    JspostRate();
            //}
            else if (eventArg == "jsPostChgfixDate") { JsPostChgfixDate(); }
        }

        private void JsPostChgfixDate()
        {
            DwFix.SetItemDateTime(1, "due_date", DwFix.GetItemDateTime(1, "due_date"));
        }
        ...
        public void SaveWebSheet()
        {
            ...
            {
                //DwMain.UpdateData();
                DwUtil.UpdateDataWindow(DwMain, "dpdepttypecond.pbl", "DPDEPTTYPE");

                // DwSaving.UpdateData();
                DwUtil.UpdateDataWindow(DwSaving, "dpdepttypecond.pbl", "DPDEPTTYPE");

                // DwFix.UpdateData();
                DwUtil.UpdateDataWindow(DwFix, "dpdepttypecond.pbl", "DPDEPTTYPE");

                //DwFixOther.UpdateData();
                DwUtil.UpdateDataWindow(DwFixOther, "dpdepttypecond.pbl", "DPDEPTTYPE");
                ...
                DwUtil.UpdateDataWindow(DwInterestBf, " dpdepttypecond.pbl", "DPDEPTPREVIOSWITHD");
        ...
        {
            //HfDeptType.Value = typeCode;
            //DwUpInt.Retrieve(state.SsCoopControl, typeCode);
            ...
            try
            {
                ...
                try
                {
                    String sqdel_interest = @"delete dpdeptintrate where depttype_code = '" + depttype_code + @"' 
                                        and effective_date = convert(datetime,'" + dtm.ToString() + "'')";
