    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">            
            <tr>
                ...
                <td>
                    <asp:TextBox ID="req_date" runat="server" Style="text-align:center;" ReadOnly="true" BackColor="#DDDDDD"></asp:TextBox>                            
                </td>
                <td width="15%">
                    <div>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="child_prename_code" runat="server" Style="text-align:center;">
                        <asp:ListItem Value="01">นาย</asp:ListItem>
                        <asp:ListItem Value="03">นางสาว</asp:ListItem>
                        <asp:ListItem Value="08">ว่าที่ร้อยตรี</asp:ListItem>
                        <asp:ListItem Value="49">ด.ช.</asp:ListItem>
                        <asp:ListItem Value="50">ด.ญ.</asp:ListItem>
                    </asp:DropDownList>            
                </td>                 
                <td >
                    <div>
