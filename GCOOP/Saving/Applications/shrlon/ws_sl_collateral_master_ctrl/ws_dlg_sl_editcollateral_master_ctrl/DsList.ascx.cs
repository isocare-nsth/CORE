    ...
    public partial class DsList : DataSourceRepeater
    {
        ...
        public void RetrieveList(string sql_search)
        {
            String sql = @"select 
                                ...
                                from   mbmembmaster,mbucfprename,lnucfcollmasttypegrp,lnucfcollmasttype 

                                left join lncollmaster on lnucfcollmasttype.collmasttype_code = lncollmaster.collmasttype_code 
                                where
                                lncollmaster.member_no = mbmembmaster.member_no and
                                mbucfprename.prename_code = mbmembmaster.prename_code and 
                                lnucfcollmasttypegrp.collmasttype_grp = lncollmaster.collmasttype_grp  
                                " + sql_search + @"order by lncollmaster.collmast_no ";
