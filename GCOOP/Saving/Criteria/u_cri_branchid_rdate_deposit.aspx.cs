...
{
    public partial class u_cri_branchid_rdate_deposit : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "ecoop_id", "criteria.pbl", state.SsCoopControl);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "ecoop_id", state.SsCoopId);
        ...
        private void RunProcess()
        {
            ...
            String ecoop_id = dw_criteria.GetItemString(1, "ecoop_id");
            //แปลง Criteria ให้อยู่ในรูปแบบมาตรฐาน.

            ReportHelper lnv_helper = new ReportHelper();

            lnv_helper.AddArgument( coop_id, ArgumentType.String );
            lnv_helper.AddArgument( ecoop_id, ArgumentType.String );
