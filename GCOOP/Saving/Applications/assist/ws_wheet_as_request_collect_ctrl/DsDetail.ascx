        ...
        <table class="DataSourceFormView" style="width: 758px;">
           <tr>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <asp:TextBox ID="resign_date" runat="server" ReadOnly="true" BackColor="#DCDCDC" Style="text-align:center"></asp:TextBox>
                    </div>
                </td>
                <td>
                    <div>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <asp:TextBox ID="monthcollect" runat="server" ReadOnly="true" ToolTip="#,##0" BackColor="#DCDCDC" Style="text-align:right"></asp:TextBox>
                    </div>
                </td>   
                <td>
                    <div>
