    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width:720px;">           
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="MEMBER_FLAG" runat="server" style="background-color:#ffa366">
                        ...
                        <asp:ListItem Value="4">สังกัดสมาชิก</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td width="20%">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:TextBox ID="VAT_AMT" runat="server" ToolTip="#,##0.00" style="text-align:right" Width="98%"></asp:TextBox>        
                </td>                                                                             
            </tr>        
            <tr>
                <td>
