...
{
    public partial class u_cri_coopid_year_rgroup_paytype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string methpaytype_code = dsMain.DATA[0].methpaytype_code;
            ...
            try
            {
                ...
                arg.Add("as_methpaytype", iReportArgumentType.String, methpaytype_code);
