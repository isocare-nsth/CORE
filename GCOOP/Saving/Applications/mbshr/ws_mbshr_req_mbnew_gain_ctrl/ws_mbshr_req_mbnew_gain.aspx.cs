...
{
    public partial class ws_mbshr_req_mbnew_gain : PageWebSheet, WebSheet
    {
        ...
        public void age()
        {
            try
            {
                ...
                string ls_age; string age = "";
               //decimal age = 0;
                DateTime retry_date = state.SsWorkDate;

                string sql = @"select dbo.ft_retrydate( {0} , {1} ) as retry, dbo.ftcm_calagemth( {2}, getdate()) as age";
