...
namespace Saving.Applications.app_finance.w_sheet_canecelchq_ctrl
{
    public partial class w_sheet_canecelchq : PageWebSheet, WebSheet
    {
        ...
        public void RetriList()
        {
            ...
            {
                sqlwhere += " and FINCHQEUESTATEMENT.DATE_ONCHQ between to_date('" + dsMain.DATA[0].start_date.ToString("dd/MM/yyyy") + "', 'dd/MM/yyyy') and to_date('" + dsMain.DATA[0].end_date.ToString("dd/MM/yyyy") + "', 'dd/MM/yyyy')";
            }
