<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_reqdeposit.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_reqdeposit" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CommitPrintFirstPage() {
            ...
            Gcoop.OpenIFrameExtend(900, 300, "w_dlg_dp_printbook.aspx", "?deptAccountNo=" + deptAccountNo);
        }
        ...
        function OnDwGainButtonClicked(sender, rowNumber, buttonName) {
            if (buttonName == "b_codep") {
                ...
                Gcoop.OpenIFrameExtend(600, 500, "w_dlg_dp_reqdetail.aspx", "?seq_no=" + objDwGain.GetItem(rowNumber, "seq_no"));
            }
        }
        ...
        function OnDwMainButtonClicked(sender, rowNumber, buttonName) {
            if (buttonName == "b_member") {
                ...
                Gcoop.OpenIFrameExtend(485, 489, "w_dlg_dp_current_account_no.aspx", "");
            }
                ...
                var memberFlag = objDwMain.GetItem(rowNumber, "member_flag");
                if (memberFlag == 1) {
                    Gcoop.OpenIFrameExtend(550, 590, "w_dlg_dp_deptaccount_search.aspx", "?member_no=" + objDwMain.GetItem(1, "member_no"));
                } else {
                    Gcoop.OpenIFrameExtend(580, 590, "w_dlg_dp_deptaccount_search.aspx", "");
                }
            }
        ...
        function SheetLoadComplete() {
            ...
            if (Gcoop.GetEl("HdCheckApvAlert").value == "true") {
                ...
                Gcoop.OpenIFrameExtend(240, 170, "w_iframe_dp_addapv_task.aspx", "?processId=" + processId + "&avpCode=" + avpCode + "&itemType=" + itemType + "&avpAmt=" + avpAmt);
            }
            if (Gcoop.GetEl("HdSaveAccept").value == "true") {
                var deptAccountNo = Gcoop.GetEl("HdAccoutNo").value;
                var deptPassBookNo = Gcoop.GetEl("HdPassBookNo").value;
                Gcoop.OpenIFrameExtend(450, 150, "w_iframe_dp_printfirstpage.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo);
            }
