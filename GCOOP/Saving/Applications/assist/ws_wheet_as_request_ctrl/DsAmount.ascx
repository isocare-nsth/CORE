                ...
                <td>
                    <table class="DataSourceFormView"  style="width:300px;">                  
                        <tr>         
                            <td>
                                <div>
                                    <span style="height:30px;">ยอดเงินตามสิทธิ์:</span>
                                </div>
                            </td>                        
                            <td width="150px">              
                                <asp:TextBox ID="system_amt" runat="server"  BackColor="#00000" ForeColor="#CCFF33" ReadOnly="true" ToolTip="#,##0.00" Style="font-size:20px;text-align:right;height:30px;" OnKeyPress="return chkNumber(this)"></asp:TextBox>                   
                            </td>  
                       </tr>  
                       <tr>         
                            <td>
                                <div>
                                    <span style="height:30px;">ยอดเงินที่เคยได้:</span>
                                </div>
                            </td>                        
                            <td width="150px">              
                                <asp:TextBox ID="ever_amt" runat="server"  BackColor="#00000" ForeColor="#CCFF33" ReadOnly="true"  ToolTip="#,##0.00" Style="font-size:20px;text-align:right;height:30px;" OnKeyPress="return chkNumber(this)"></asp:TextBox>                   
                            </td>  
                       </tr>   
                       <tr>         
                            <td>
                                <div>
                                    <span style="height:30px;">ยอดเงินสุทธิ:</span>
                                </div>
                            </td>                        
                            <td width="150px">              
                                <asp:TextBox ID="approve_amt" runat="server"  BackColor="#00000" ForeColor="#CCFF33" ToolTip="#,##0.00" Style="font-size:20px;text-align:right;height:30px;" OnKeyPress="return chkNumber(this)"></asp:TextBox>                   
                            </td>  
                       </tr>             
                    </table>
                </td>
