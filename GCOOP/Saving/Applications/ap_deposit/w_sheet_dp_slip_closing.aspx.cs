...
{
    public partial class w_sheet_dp_slip_closing : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (DwMain.RowCount < 1)
            {
                ...
                string cashType = "";
                DwMain.Modify("recppaytype_desc_t.text='CCA  ปิดบัญชีด้วยเงินสด'");
                DwMain.SetItemString(1, "recppaytype_code", "CCA");
                DwMain.SetItemString(1, "deptwith_flag", "/");
                try
                {

                    cashType = ndept.of_get_cashtype(state.SsWsPass, "CCA");
        ...
        public void WebSheetLoadEnd()
        {
            ...
            if (!String.IsNullOrEmpty(deptAccountNo))
            {
                ...
                {
                    DwMain.SetItemString(1, "group_itemtpe", ndept.of_getrevpaygrp(state.SsWsPass, "CCA"));
                    DwMain.Modify("recppaytype_desc_t.text='CCA  ปิดบัญชีด้วยเงินสด'");
                    DwMain.SetItemString(1, "recppaytype_code", "CCA");
                    DwMain.SetItemString(1, "deptwith_flag", "/");
                    try
