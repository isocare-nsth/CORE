<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="ws_mbshr_req_mbnew_gain.aspx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_req_mbnew_gain_ctrl.ws_mbshr_req_mbnew_gain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function MenubarOpen() {
            Gcoop.OpenIFrame("600", "580", "w_dlg_sl_member_new_search.aspx", "")
        }
        ...
        function OnDsMainItemChanged(s, r, c, v) {
            if (c == "membdatefix_flag") {
                ...
                if (v == "1") {
                    ...
                    //         
                    //b_linkaddress2 mateprovince_code mateamphur_code matetambol_code 
                } else {
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_linkaddress") {
                ...
                Gcoop.OpenIFrame2('630', '600', 'w_dlg_mbshr_mem_search.aspx', '');
            } else if (c == "b_bank") {
