    ...
    public partial class DsDetail : DataSourceFormView
    {
        ...
        public void RetrieveData(String ls_member_no)
        {
            String sql = @" 
                    ...
                    ,mb.resign_status,mb.resign_date,(select rc.resigncause_desc from mbucfresigncause rc where  mb.resigncause_code = rc.resigncause_code) resigncause_desc,sm.sharestk_amt*st.unitshare_value as sharestk_amt,sm.last_period
                    ,trunc(MONTHS_BETWEEN( mb.resign_date , mb.member_date) )  as monthcollect, sm.sharespx_amt*st.unitshare_value as sharespx, ((sm.sharespx_amt + sm.sharestk_amt)*st.unitshare_value) as sum_sharestk
