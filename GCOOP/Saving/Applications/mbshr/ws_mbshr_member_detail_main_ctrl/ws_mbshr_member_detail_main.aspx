...
<%@ Register src="DsTranfer.ascx" tagname="DsTranfer" tagprefix="uc23" %>
<%@ Register src="DsCremation.ascx" tagname="DsCremation" tagprefix="uc24" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_search") {
                Gcoop.OpenIFrame(650, 600, 'w_dlg_sl_member_search.aspx', '')
            }
            else if (c == "b_print") {
                PopupReportshr();
            }
        ...
        function OnDsKeepdataClicked(s, r, c) {
            if (c == "b_detail") {
                ...
                Gcoop.OpenIFrame3("700", "400", "w_dlg_mb_detail_keepdatadet.aspx", "?memno=" + ls_memno + "&recvperiod=" + ls_recvperiod);
...
//                //            Gcoop.SetFocus(0,"member_no");
//                Gcoop.getElementById("member_no").focus();
////            Gcoop.Focus();
//            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-12">รายการโอนย้าย</a></li>
            <li><a href="#tabs-13">รายการฌาปนกิจ</a></li>
        </ul>
        <div id="tabs-1">
        ...
        <div id="tabs-12" >
            <uc23:DsTranfer ID="dsTranfer" runat="server" />
        </div>
        <div id="tabs-13" >
            <uc24:DsCremation ID="dsCremation" runat="server" />
        </div>
    </div>
